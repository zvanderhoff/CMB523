...
i is every value in the sequencing matrix starting from 1 and going to the number of rows
j is every number in the matrix going from 1 to the number of columns

for every row i, each column j is checked
...
nrow and ncol were being called more often in the first version making it slower
...
Method 1 took 1.2 minutes so about 72 seconds, method 3 took about 0.3 seconds so about 1/240th the time
